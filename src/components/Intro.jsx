    ...
    return (
        <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
            ...
            <p className='text-sm max-w-xl mb-6 font-bold'>
                ...
                This was created in collaboration with the <a href='https://www.mhfoodbank.com/' className='text-green-600 hover:underline underline-offset-2 decoration-1'>Medicine Hat Food Bank</a>.
            </p>
        </div>
    )
}
