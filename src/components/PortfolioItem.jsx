      ...
      <a className="text-lg md:text-2xl hover:text-blue-500 hover:underline" target="_blank"
         ...
         <div className="w-full p-4">
            ...
            <p className="flex flex-wrap gap-2 flex-row items-center justify-start text-xs md:text-sm dark:text-white">
               {stack.map(item => (
                  <span className="rounded-full text-stone-900 bg-stone-300 inline-block px-2 py-1 font-semibold border-2 border-stone-900 dark:border-stone-300 rounded-md">
                     {item}
                  </span>
               ))}
            </p>
